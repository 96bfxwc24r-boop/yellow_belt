...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill development, pick-up games, and intramural play",
    ...
    "Science Club": {
        "description": "Experiments, guest speakers, and science fairs",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["noah@mergington.edu", "sophia.k@mergington.edu"]
    },
    "Debate Team": {
